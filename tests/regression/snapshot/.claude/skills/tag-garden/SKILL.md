...
When Obsidian CLI is available, prefer `obsidian tags sort=count counts` and `obsidian tag name=<tag> verbose` over Grep sweeps. See `.claude/references/obsidian-cli.md`.
