...
When filing notes, **prefer the Obsidian CLI** over filesystem `mv` so Obsidian updates wikilinks and attachment hooks. Follow `.claude/references/obsidian-cli.md`.
