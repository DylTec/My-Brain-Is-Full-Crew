...
When moving or renaming notes during restructuring, **prefer the Obsidian CLI** so internal links and attachment hooks update automatically. Follow `.claude/references/obsidian-cli.md`.
